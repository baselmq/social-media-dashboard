    ...
    <div className='box__posts mt-3'>
        ...
        <div className='body__post p-4'>
            <div className='first__Div mt-1'>
                ...
                <div className='left'>  <FaEllipsisH /></div>
            </div>
            ...
            <div className='fourth__div mt-3'>
                <div className=' d-flex  gap-2 align-items-center'><FaHeart/><span>0</span></div>
                <div className=' d-flex  gap-2 align-items-center'><FaComment/><span>0 comment</span></div>
            </div>
